...
class SocialLoginRequiredView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SocialLoginRequiredView> createState() =>
      _SocialLoginRequiredViewState();
}

class _SocialLoginRequiredViewState
    extends ConsumerState<SocialLoginRequiredView> {
  ...
  Future<void> _handleLogin(AuthProvider provider) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            '로그인에 실패했습니다: ${err.toString().replaceFirst('Exception: ', '')}',
          ),
        ),
      );
    } finally {
