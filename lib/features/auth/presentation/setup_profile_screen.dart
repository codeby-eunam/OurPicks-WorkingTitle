...
class _SetupProfileScreenState extends ConsumerState<SetupProfileScreen> {
  ...
  bool get _isFormReady =>
      _userIdRegex.hasMatch(_userIdController.text) &&
    ...
    try {
      await ref
          ...
          .setupProfile(
            ...
            provider: AuthProvider.fromName(
              widget.provider.isEmpty ? 'kakao' : widget.provider,
            ),
          );
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              if (_userIdController.text.length > 1 ||
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: (!_isFormReady || _isLoading)
                      ? null
                      : _handleSubmit,
